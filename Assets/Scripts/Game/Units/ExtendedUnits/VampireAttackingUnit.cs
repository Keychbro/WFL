...
namespace WOFL.Game
{
    public class VampireAttackingUnit : Unit, IAttacking, IMoveable, ISlowdownable, IFlammable
    {
        #region  Variables
        ...
        protected VampireUnitLevelInfo _vampireUnitLevelInfo;
        ...
        public virtual async void Attack()
        {
            ...
            if (_weapon != null)
            {
                ...
                if (result)
                {
                    if (_vampireUnitLevelInfo != null) Heal(Mathf.RoundToInt(_weapon.CurrentWeaponLevel.Damage * _vampireUnitLevelInfo.LifestealValue));
                }
            }
